      ...
      <div className="px-container py-12">
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 md:flex-row">
          ...
          <div className="flex items-center gap-3">
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="text-white/30 hover:text-white/70 transition-colors">
            ...
            {/* X / Twitter */}
            <a href="#" aria-label="X" className="text-white/30 hover:text-white/70 transition-colors">
