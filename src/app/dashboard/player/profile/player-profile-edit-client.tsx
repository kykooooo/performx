                ...
                <div className="px-card p-6">
                  ...
                  <div className="flex items-center gap-5 mb-6">
                    <div className="relative">
                      <div className="relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-2xl border-2 border-white/20 bg-gradient-to-br from-blue-500/20 to-transparent text-white shadow-lg">
                        {avatarUrl ? (
