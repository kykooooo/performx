                    ...
                    {completed.slice(0, 2).map((session) => (
                      <div key={session.id} className="flex items-center gap-4 rounded-xl p-3 text-white/40">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-white/30">{formatLongDate(new Date(`${session.date}T12:00`))} · {session.time}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-2 grid grid-cols-[80px_repeat(7,minmax(0,1fr))] gap-2">
                    {timeSlots.map((time) => (
                      <div key={time} className="contents">
                        <div className="flex items-center justify-center text-xs text-white/30">{time}</div>
                        {weekDays.map((day) => {
