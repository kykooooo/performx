    ...
    <AuthShell title="Créer un compte" subtitle="Choisis ton profil pour commencer.">
      <div className="grid gap-4">
        ...
        <div className="px-card p-5">
          ...
          <p className="mt-2 text-sm text-white/70">Propose tes disponibilités et reçois des réservations.</p>
        ...
        <div className="px-card p-5">
          ...
          <p className="mt-2 text-sm text-white/70">Suis la progression de ton enfant et réserve ses séances.</p>
